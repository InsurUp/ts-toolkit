# InsurUp SDK Web Demo (SPA / Vanilla TypeScript)

A comprehensive Single Page Application demo for the InsurUp SDK built with vanilla TypeScript. This demo showcases OAuth2/PKCE authentication, GraphQL queries with pagination, and CRUD operations using only vanilla TypeScript with no framework dependencies.
