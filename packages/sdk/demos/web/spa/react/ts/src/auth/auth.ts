 ...
 * client secret. Tokens persist across reloads via localStorage.
 */
...
const PKCE_VERIFIER_KEY = 'insurup-demo-pkce-verifier';
const PKCE_STATE_KEY = 'insurup-demo-pkce-state';
