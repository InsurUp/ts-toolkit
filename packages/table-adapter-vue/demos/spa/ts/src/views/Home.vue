...
<template>
  ...
  >
    ...
    <h1 class="text-4xl font-bold tracking-tight mb-4">
      Table Adapter Vue Demo
    </h1>
    <p class="text-xl text-muted-foreground mb-8 max-w-md">
      A Vue SPA demonstrating the @insurup/table-adapter-vue package
    ...
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
        ...
        <p class="text-sm text-muted-foreground">
          View customers using the useCustomerTable composable with TanStack Table.
