/**
 * @fileoverview Vue composable for Agent Insurance Company Table — thin wrapper over `useTable`.
 */
...
/**
 * Vue composable for creating and managing a agent insurance company table.
