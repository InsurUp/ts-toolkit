/**
 * @fileoverview Vue composable for FilePolicyTransfer Table — thin wrapper over `useTable`.
 */
...
/**
 * Vue composable for creating and managing a filepolicytransfer table.
