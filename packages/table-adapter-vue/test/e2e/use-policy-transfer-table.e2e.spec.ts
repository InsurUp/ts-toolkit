/**
 * @fileoverview E2E: usePolicyTransferTable composable against the real InsurUp API.
 *
...
type Options = PolicyTransferTableOptions<PolicyTransferColumnDef[]>;

function mountWith(options: Options) {
  const TestComponent = defineComponent({
    setup() {
      return usePolicyTransferTable(options);
    },
    template: '<div />',
  });
